...
public class ChessGameController {
    ...
    public static void initializeGame() {
        ...
        Piece WhiteBishop1 = new PieceBishop(0,5,chessGame.getPlayer(0));
        Piece WhiteKnight1 = new PieceKnight(0,6,chessGame.getPlayer(0));
        ...
        Piece BlackBishop1 = new PieceBishop(7,5,chessGame.getPlayer(1));
        Piece BlackKnight1 = new PieceKnight(7,6,chessGame.getPlayer(1));
